...
@Component({
  selector: 'app-rates-and-inventory',
  templateUrl: './rates-and-inventory.component.html',
  styleUrls: ['./rates-and-inventory.component.scss']
})
export class RatesAndInventoryComponent {
