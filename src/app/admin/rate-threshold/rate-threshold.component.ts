...
@Component({
  selector: 'app-rate-threshold',
  templateUrl: './rate-threshold.component.html',
  styleUrls: ['./rate-threshold.component.scss']
})
export class RateThresholdComponent {
  displayedColumns: string[] = ['customerName', 'villaName', 'price',  'noOfVillas'];
